...
# NOTE: You might want to remove this if circleci is not hosted on GitHub releases.
...
download_release() {
  ...
  local platform
  # TODO: Consider adding windows builds since they are provided by circleci
...
install_version() {
  ...
  (
    ...
    # TODO: Asert circleci executable exists.
    local tool_cmd
